                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('brand/edit/'.$brand->id)}}" class="btn btn-info btn-sm">Update</a>
                                        <a href="{{url('brand/remove/'.$brand->id)}}" class="btn btn-danger btn-sm">Remove</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('brand/restore/'.$trash->id)}}" class="btn btn-info btn-sm">Restore</a>
                                <a href="{{url('brand/delete/'.$trash->id)}}" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
